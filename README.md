...
My thesis involves using the [Proximal Policy Optimisation (PPO) algorithm](https://arxiv.org/pdf/1707.06347.pdf) to train an agent to balance a double inverted pendulum (DIP). The initial modelling of the system can be found [here](https://github.com/mughees-asif/dip#double-inverted-pendulum-dip-modelling). The project is due for completion by Apr. 2021.
