...
Hi there! Welcome to my GitHub profile. My name is **[Mughees Asif](https://drive.google.com/file/d/1G6JxlZoch6AaJ21ecg7vZtIH_eTeN8wx/view?usp=sharing)** and I am an *Aerospace Engineering* undergraduate @ [Queen Mary, University of London](https://www.qmul.ac.uk/undergraduate/coursefinder/courses/2020/aerospace-engineering/). I have self-taught myself a plethora of different technologies, and I am currently looking to enter the Software Development industry upon my graduation (*June, 2022*), with an emphasis on working in the Fintech, Blockchain, Cryptocurrency, and Android Development sectors. My proficiency in languages such as Java *SE 11*, Kotlin, JavaScript and Python, can be seen from the various projects below.  
