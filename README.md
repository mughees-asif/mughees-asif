...
I am interested in the application of graph neural networks (GNNs) for relational reasoning in the criminal justice system, where the modern applications of deep transfer learning by harnessing the possibility of using latent relational graphs, will enable my endeavour to encourage the UK justice system to adopt algorithmic analysis to gauge recidivism risks.
